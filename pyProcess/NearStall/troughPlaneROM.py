...
spath='/home/rperezt/Documents/thesis/figures/nearStall/troughROM{}/'.format(sfolder)

dpath='/home/rperezt/Documents/thesis/data/nearStall/troughROM{}/'.format(sfolder)
...
f,a,im=fl.blk[block].contourf(varname='p',vmin=0.5,vmax=0.7,nlvl=21,cmap=plt.cm.hot,bar=False);nfig+=1
figs.append(f);axs.append(a)    
